package com.mickyli.util.json.jsonlib;
...
import com.mickyli.util.json.MyBean;
import com.mickyli.util.json.MyBeanWithPerson;
import com.mickyli.util.json.Person;
